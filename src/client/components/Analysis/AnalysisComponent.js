...
const tooltips = {
  ...
  communication:
    "좋아요 클릭수량 대비 댓글 수로서 팔로워와의 인터랙션 지수를 말합니다 공감지수가 높으면 팔로워와의 소통이 원활하며 영향력지수가 높아집니다",
  activity: "특정 범위 동안 온라인 상태였던 인스타 사용자 팔로워 수 합계.",
  impressions:
    "인스타그램 사용자의 미디어가 조회된 횟수 합계. 홍보 기능을 통해 생성된 광고 활동을 포함합니다..",
  activeFollowers:
    "원래 팔로워수 온라인상태 팔로워수 비율. X축 시간. 팔로원들이 가장 강력하게 보는 시간 영향력있는 시간 팔로워들의 활동시간 분석",
};
const testImage =
  "https://scontent-ssn1-1.cdninstagram.com/v/t51.2885-15/sh0.08/e35/s640x640/44191010_877274945801500_683676639501143736_n.jpg?tp=1&_nc_ht=scontent-ssn1-1.cdninstagram.com&_nc_cat=104&_nc_ohc=SMM5lzTWsXsAX9JK4qs&edm=AP_V10EBAAAA&ccb=7-4&oh=971b324811b253d368244c569a59e114&oe=60D9D799&_nc_sid=4f375e";
const testData = {
  audience3: {
    ...
    datasets: [
      {
        label: "# of Votes",
        data: [4.15, 0.69],
        backgroundColor: ["rgba(24, 219, 168, 1)", "rgba(231, 251, 246, 0.6)"],
        borderWidth: 2,
        borderRadius: 20,
        borderSkipped: false,
      },
...
const defaultData = {
  ...
  INS_SCORE: 0,
  INS_TYPES:
    "Smile Cloud Table Tableware Decoration Photograph Dog Light Land vehicle Jeans Forehead Ecoregion Trousers Green Hairstyle Hair Water Umbrella Picture frame Sky Rectangle",
  ability: "",
  abilityType: "",
  influencerType: "",
  mediaData: {
...
function AnalysisComponent(props) {
  ...
  async function getInstaInfo() {
    try {
      setLoading(true);
      const res = await axios.get("/api/TB_INSTA/instaInfoNew", {
        ...
        <Box px={2} py={2} maxWidth="1350px" m="0 auto">
          <Box mb="30px" mt="15px">
            <Grid container spacing={2}>
              <Grid item xs={12} md={3}>
                <Box className={`${classes.box} ${classes.bgBlue} ${classes.youtubeLink}`}>
                  <Grid container alignItems="center" style={{ height: "100%" }}>
                    <Grid item>
                      <img
                        ...
                        src={instaData.INS_PROFILE_IMG || defaultAccountImage}
                        alt="noImage"
                      />
                    </Grid>
                    <Grid item xs>
                      <Box maxWidth="300px" ml={2} fontSize={23} fontWeight="bold">
            ...
            <Grid item xs={12} md={4}>
              ...
              >
                <Box py="13px" px={2}>
                  <Grid container justify="space-between">
                    <Grid item>
                      <Typography variant="body1">팔로워 주요 국적</Typography>
                    </Grid>
                    <Grid item>
                      <Typography variant="body1" classes={{ root: classes.bold600 }}>
                ...
                <Box py="13px" px={2} bgcolor="#FFF">
                  <Grid container justify="space-between">
                    <Grid item>
                      <Typography variant="body1">팔로워 성비</Typography>
                    </Grid>
                    <Grid item>
                      <Typography variant="body1" classes={{ root: classes.bold600 }}>
                        {instaData.genderMax}
                ...
                <Box py="13px" px={2}>
                  <Grid container justify="space-between">
                    <Grid item>
                      <Typography variant="body1">팔로워 연령</Typography>
                    </Grid>
                    <Grid item>
                      <Typography variant="body1" classes={{ root: classes.bold600 }}>
                        {instaData.ageMax}
            ...
            <Grid item xs={12} md={4}>
              ...
              >
                <Box py="13px" px={2}>
                  <Grid container justify="space-between">
                    <Grid item>
                      <Typography variant="body1">최근 1주일간 새로운 팔로워신청</Typography>
                    </Grid>
                    <Grid item>
                      <Typography variant="body1" classes={{ root: classes.bold600 }}>
                ...
                <Box py="13px" px={2} bgcolor="#FFF">
                  <Grid container justify="space-between">
                    <Grid item>
                      <Typography variant="body1">주 평균 게시물을 업로드</Typography>
                    </Grid>
                    <Grid item>
                      <Typography variant="body1" classes={{ root: classes.bold600 }}>
          ...
          <Box p={2} mt={{ xs: "25px", md: "50px" }} bgcolor="#F2F2F2">
            <Typography variant="subtitle2">
              {`${instaData.INS_NAME}는 ${instaData.INS_FLWR}명의 팔로워를 보유하고 있으며 이는 ${
                ...
                ${instaData.monthMedia.likeSum}건의 좋아요수와 ${
                instaData.monthMedia.commentsSum
              }건의 댓글을 받아 공감능력은 ${instaData.ability}%(${
                ...
                게시물 인공지능분석 결과 가장 높은 비율인 ${imgDetectMax.value}%를 (${
                imgDetectMax.description
              })가 차지하고 있어서
                ${imgDetectMax.description} 쪽에 영향력 지수가 크다고 보여집니다.
                (제일 높은 이미지의 %가 30% 이하이면 ... 특별한 카테고리에 영향력이 없다고 보여집니다.)
                ${instaData.INS_NAME}님은 ${DAY_OF_WEEK[instaData.postStats.dayMaxIdx]}요일, 오후 ${
                HOURS[instaData.postStats.hourMaxIdx]
              }시 주로 게시물을 업로드 하고 있습니다.`}
            </Typography>
          </Box>
