...
import {
  Box, makeStyles, Table, TableBody, TableHead, TableRow, TableCell
...
const PrivacyContent = [
  ...
  {
    title: '회원 및 그 법정대리인의 권리와 그 행사방법',
    content: [
  ...
  },
  {
    ...
    content: [
      ...
      [
        '- 스팸(spam)성 게시물 (예 : 특정사이트에 대한 광고, 타 사이트로의 유도 광고 및 링크 등)',
        '- 타인을 비방할 목적으로 허위 사실을 유포하여 타인의 명예를 훼손하는 글',
        '- 동의 없는 타인의 신상공개, 회사의 저작권, 제3자의 지적재산권 등 권리를 침해하는 내용, 기타 게시판 주제와 다른내용의 게시물'
      ]
    ]
  },
  {
    title: '개인정보 자동수집 장치(쿠키 등)의 설치, 운영 및 그 거부에 관한 사항',
    content: [
      '가. 회사는 회원들에게 보다 적절하고 유용한 서비스를 제공하기 위하여 회원의 정보를 수시로 저장하고 불러오는 ‘쿠키(cookie)’를 사용합니다.',
      ['쿠키란 회사의 웹사이트를 운영하는데 이용되는 서버가 회원의 컴퓨터로 전송하는 아주 작은 텍스트 파일로서 회원의 컴퓨터 하드디스크에 저장됩니다. 회원은 쿠키의 사용여부에 대하여 선택하실 수 있습니다.'],
      '나. 쿠키 설정 거부 방법',
      ['회원은 사용하시는 웹 브라우저의 옵션을 설정함으로써 모든 쿠키를 허용하거나 쿠키를 저장할 때마다 확인을 거치거나, 모든 쿠키의 저장을 거부할 수 있습니다. 단, 쿠키의 저장을 거부할 경우 로그인이 필요한 일부 서비스의 이용에 제한이 생길 수 있음을 양지하시기 바랍니다.',
  ...
  },
  {
    ...
    content: [
      ...
      '라. 내부관리계획의 수립 및 시행',
      ['회사는 내부관리계획을 수립 및 시행합니다.'],
      '마. 접속기록의 보관 및 위변조 방지',
      ['회사는 개인정보처리시스템에 접속한 기록(웹 로그, 요약정보 등)을 최소 6개월 이상 보관, 관리하고 있으며, 접속 기록이 위변조 및 도난, 분실되지 않도록 관리하고 있습니다.'],
      '바. 해킹 등에 대비한 기술적 대책',
      ...
      '사. 비인가자에 대한 출입 통제',
      ['회사는 개인정보를 보관하고 있는 개인정보시스템의 물리적 보관 장소를 별도로 두고 이에 대해 출입통제 절차를 수립, 운영하고 있습니다']
    ]
  },
  {
    title: 'SNS 정책 동의',
  ...
  },
  {
    ...
    content: [
      ...
      [
        '1. 정보보호마크인증위원회www.eprivacy.or.kr/02-550-9531~2)',
        '2. 개인정보침해신고센터 (www.118.or.kr / 국번없이 118)',
        '3. 대검찰청 사이버범죄수사단 (www.spo.go.kr / 02-3480-3571)',
        '4. 경찰청 사이버테러대응센터 (www.ctrc.go.kr / 국번없이 182)'
      ]
...
const TableRowContent = {
  userInfo: [
    ['회원가입', '인스타그램 로그인 아이디, 성명, 휴대폰번호, 이메일, 암호화된 이용자 확인값(CI)', '생년월일, 성별, 지역, 배송지주소, 계좌정보'],
    ['광고주 가입', '회사명, 사업자등록번호, 이메일, 비밀번호, 담당자 성명, 담당자 연락처', '직급(직책), 회사 홈페이지'],
    ['광고주/판매업체 제품 판매 관련', '계좌정보(은행명, 계좌정보, 예금주), 주소, 업태, 업종', '통신판매업등록번호, 홈페이지, 고객센터등']
  ],
  infoDelete: [
    ['광고주/판매업체', '상품 및 서비스 배송(전송), 구매자확인, CS', '성명, 이메일, 주소, 휴대폰번호', '재화 또는 서비스 제공을 완료한 후, 내부 방침 및 기타 관련법령에 의한 정보보호 사유에 따라(제2조. 개인정보의 처리 및 보유 기간) 일정 기간 저장 후 파기'],
  ],
  services: [
    ['본인확인', '이메일인증', '휴대폰 인증'],
    ['알람 발송', '(주)카카오', 'SMS 및 메시지 발송'],
    ['배송서비스', '광고주/판매업체가 이용하는 배송사', '상품 배송'],
    ['전자결제', '주식회사 KCP', '신용카드'],
    ['데이터 보관', 'Amazon Web Services, Inc', '데이터 보관'],
  ],
};
...
function Privacy() {
  ...
  return (
    <Box m="0 auto" maxWidth="1160px" px={{ xs: 2, lg: 0 }}>
      <Box py={{ xs: '25px', md: '45px' }} mx="-700px" px="700px" fontSize={{ xs: '35px', md: '50px' }} fontWeight="300" color={Colors.black2} borderBottom="1px solid #e9e9e9">개인정보처리방침</Box>
              ...
              <Box mt="14px">
                { item.content.map((contentItem, contentIndex) => (
                  <React.Fragment>
                    ...
                    <ContentTable firstIndx={index} secondIndx={contentIndex} />
                  </React.Fragment>
                )) }
              </Box>
            ) : null }
...
function ContentTable(props) {
  const { firstIndx, secondIndx } = props;
  const classes = useStyles();

  if (firstIndx === 2 && secondIndx === 0) {
    return (
      <Box my={2}>
        <Table>
          ...
          <TableBody>
            {TableRowContent.userInfo.map(item1 => (
              <TableRow>
                {item1.map(item2 => (
                  <TableCell>
                    {item2}
          ...
          <TableHead classes={{ root: classes.tableHead }}>
            <TableRow>
              ...
              <TableCell width="400px">
                  개인정보를 제공받는 자의 개인 정보보유 및 이용기간
              </TableCell>
            </TableRow>
          </TableHead>
          <TableBody>
            {TableRowContent.infoDelete.map(item1 => (
              <TableRow>
                {item1.map(item2 => (
                  <TableCell>
                    {item2}
    ...
    return (
      <Box my={2}>
        <Table>
          ...
          <TableBody>
            {TableRowContent.services.map(item1 => (
              <TableRow>
                {item1.map(item2 => (
                  <TableCell>
                    {item2}
