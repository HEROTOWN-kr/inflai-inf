...
const PrivacyContent = [
  ...
  },
  {
    ...
    content: [
      ...
      "가. 내부 방침(부정이용기록)",
      ["보존근거 : 부정이용의 배제 등 회사 방침에 의한 보존", "보존기간 : 6개월"],
  ...
  },
  {
    ...
    content: [
      ...
      ["- Google 개인정보보호정책", "https://policies.google.com/privacy"],
    ],
  },
  {
    ...
    content: [
      ...
      "고객서비스담당 부서: CS실",
      ["전화번호: 1522-7947", "이메일: myfna@naver.com"],
      "개인정보관리책임자/개인정보보호책임자",
      ["성명: 김무성", "전화번호: 1522-7947", "이메일: myfna@naver.com"],
...
const TableRowContent = {
  userInfo: [
    [
      "이메일을 통한 가입",
      "비밀번호, 이메일주소 간편가입 이후에도 이메일을 통한 가입 과정을 거칩니다.",
      "생년월일, 성별, 지역, 배송지주소, 계좌정보",
    ],
    [
      "페이스북 간편가입",
      "이름, 프로필사진",
      "인스타그램 계정 프로필 정보 및 게시물, 인스타그램 계정 인사이트, 페이스북 페이지 및 게시 콘텐츠",
    ],
    [
      "광고주 가입",
      "회사명, 사업자등록번호, 이메일, 비밀번호, 담당자 성명, 담당자 연락처",
      "직급(직책), 회사 홈페이지",
    ],
    [
      "광고주/판매업체 제품 판매 관련",
      "계좌정보(은행명, 계좌정보, 예금주), 주소, 업태, 업종",
      "통신판매업등록번호, 홈페이지, 고객센터등",
    ],
  ],
  infoDelete: [
    [
      "광고주/판매업체",
      "상품 및 서비스 배송(전송), 구매자확인, CS",
      "성명, 이메일, 주소, 휴대폰번호",
      "재화 또는 서비스 제공을 완료한 후, 내부 방침 및 기타 관련법령에 의한 정보보호 사유에 따라(제2조. 개인정보의 처리 및 보유 기간) 일정 기간 저장 후 파기",
    ],
  ],
  services: [
    ["본인확인", "이메일인증", "휴대폰 인증"],
      ...
      <Box py={{ xs: "40px", md: "60px" }}>
        {PrivacyContent.map((item, index) => (
          <Box mt={{ xs: index === 0 ? "0" : "40px", md: index === 0 ? "0" : "70px" }}>
            <Box key={index} fontWeight="500" fontSize="18px" color={Colors.dark}>
              {item.title}
            </Box>
            {item.description ? (
        ...
        <Table>
          <TableHead classes={{ root: classes.tableHead }}>
            <TableRow>
              ...
              <TableCell>제공목적</TableCell>
              <TableCell>제공정보</TableCell>
