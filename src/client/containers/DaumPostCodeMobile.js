...
function DaumPostCodeMobile(props) {
  ...
  return (
    <div>
      <Grid container spacing={1}>
        <Grid item xs={12}>
          <Grid container spacing={1}>
            <Grid item onClick={execDaumPostCodeMobile} style={{ width: isMD ? '190px' : '50%' }}>
            ...
            <Grid item style={{ width: isMD ? '190px' : '50%' }}>
              <StyledButton onClick={execDaumPostCodeMobile} height="40px">우편번호 찾기</StyledButton>
            </Grid>
          </Grid>
        </Grid>
        <Grid item xs={12}>
      ...
      {
        searchComponent ? (
          <Box border="1px solid" width="500px" height="300px" margin="5px 0" position="relative" id="wrap">
            <img
